...
The function provides the names of categorical, numerical, and categorical but cardinal variables in the given dataset.

Note: Numeric-looking categorical variables are also included within the categorical variable category.
...
-----
    ...
    Numeric variables within cat_cols.
...
def model_data(input_file='outputs/processed_df.pkl'):
